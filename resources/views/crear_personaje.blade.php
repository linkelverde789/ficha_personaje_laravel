...
<body style="padding-top:0;">
    <form method="post" action="{{ url('insertarPersonaje') }}" style="width: 80%;">
    @csrf
        <div>
    ...
    <script src="{{ asset('js/addPoint.js') }}"></script>
    <script src="{{ asset('js/substractPoint.js') }}"></script>
    <script src="{{ asset('js/checkBonificaciones.js') }}"></script>
    <script src="{{ asset('js/checkAbilities.js') }}"></script>
    <script src="{{ asset('js/checkHP.js') }}"></script>
    <script src="{{ asset('js/hiddenPoints.js') }}"></script>
    <script src="{{ asset('js/checkObject.js') }}"></script>
    <script src="{{ asset('js/showBonusPointOnLoad.js') }}"></script>
